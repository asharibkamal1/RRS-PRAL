/* =====================================================================================
   ...
   NOTE ON USERS: do NOT insert into Users by hand. Passwords must be hashed by
...
INSERT INTO [dbo].[Roles] ([Id], [Name], [NormalizedName], [Description], [ConcurrencyStamp])
SELECT NEWID(), r.[Name], UPPER(r.[Name]), r.[Name] + ' role', NEWID()
FROM roles r
WHERE NOT EXISTS (
    SELECT 1 FROM [dbo].[Roles] x WHERE x.[NormalizedName] = UPPER(r.[Name])
);
